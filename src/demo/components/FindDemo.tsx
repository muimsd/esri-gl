  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: '10px', background: '#f5f5f5', borderBottom: '1px solid #ddd' }}>
        ...
        {findResults && (
          <div style={{ marginTop: '10px', padding: '10px', background: 'white', borderRadius: '4px', maxHeight: '200px', overflowY: 'auto' }}>
            {findResults.error ? (
              ...
              <>
                ...
                {findResults.features?.slice(0, 5).map((feature: GeoJSON.Feature, index: number) => (
                  <div key={index} style={{ marginBottom: '5px', padding: '5px', background: '#f8f9fa', borderRadius: '3px' }}>
