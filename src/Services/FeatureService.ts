...
export class FeatureService {
  ...
  updateData(): void {
    ...
    console.warn('updateData() is not applicable for vector tile sources. Use layer filtering instead.')
  }
  ...
  async queryFeatures(options?: Partial<FeatureServiceOptions>): Promise<GeoJSON.FeatureCollection> {
